...
// ---------------------------------------------------------------------------
const archers = line({ attack: 'projectile', damageType: 'pierce', targetsAir: true, targetsGround: true }, [
  {
...
// ---------------------------------------------------------------------------
const ballista = line({ attack: 'projectile', damageType: 'pierce', targetsAir: true, targetsGround: true }, [
  {
...
// ---------------------------------------------------------------------------
const siege = line({ attack: 'artillery', damageType: 'explosive', targetsAir: false, targetsGround: true }, [
  {
...
// ---------------------------------------------------------------------------
const fire = line({ attack: 'cone', damageType: 'fire', targetsAir: false, targetsGround: true }, [
  {
...
// ---------------------------------------------------------------------------
const sappers = line({ attack: 'aura', damageType: 'true', targetsAir: false, targetsGround: true }, [
  {
...
// ---------------------------------------------------------------------------
const rockets = line({ attack: 'salvo', damageType: 'explosive', targetsAir: true, targetsGround: true }, [
  {
...
// ---------------------------------------------------------------------------
const traps = line({ attack: 'trap', damageType: 'explosive', targetsAir: false, targetsGround: true }, [
  {
...
// ---------------------------------------------------------------------------
const command = line({ attack: 'support', damageType: 'true', targetsAir: false, targetsGround: false }, [
  {
